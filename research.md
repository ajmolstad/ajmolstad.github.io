...
A scalable algorithm for fitting rank-based accelerated failure time models in high dimensions.<br>
*Submitted*. <br>

**Molstad, A. J.** and Patra, R. (2020+)<br>
Dimension reduction in multi-source survival analysis. <br>
*Submitted*. <br>
